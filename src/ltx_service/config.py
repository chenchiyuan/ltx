...
class Settings:
    ...
    executor_backend: str = "mock-local"
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            executor_backend=os.getenv("LTX_EXECUTOR_BACKEND", cls.executor_backend),
    ...
    def validate_required(self) -> None:
        ...
        if self.executor_backend not in {"mock-local", "gpu-worker"}:
            raise RuntimeError(f"Unsupported LTX_EXECUTOR_BACKEND: {self.executor_backend}")
        required = {
            ...
            "LTX_EXECUTOR_BACKEND": self.executor_backend,
        }
